        ...
        <div className="bodyDiv-home">
            <div className="container-home">
                ...
                <div className="home-text">
                    ...
                    <Typography style={{ color: "rgba(238,238,238,1)" }} variant="h4">I'm a software engineer with experience in Javascript and Ruby frameworks.</Typography>
                    <Typography style={{ color: "rgba(238,238,238,1)" }} variant="h4">I hope you enjoy checking out my website and portfolio.</Typography>
